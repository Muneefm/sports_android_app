package com.mnf.sports.SplashFiles.activity;
...
import com.mnf.sports.SplashFiles.utils.UIUtil;
import com.mnf.sports.SplashFiles.utils.ValidationUtil;
...
abstract public class AwesomeSplash extends AppCompatActivity {
    ...
    private AppCompatTextView mTxtTitle,mSubTxtTitle;
    ...
    public void initUI(int flag) {
        ...
        mSubTxtTitle = (AppCompatTextView) findViewById(R.id.txtSubTitle);
    ...
    public void startTextAnimation() {
        ...
        if (!mConfigSplash.getSubTitleFont().isEmpty())
            setSubFont(mConfigSplash.getSubTitleFont());
        ...
        }).duration(mConfigSplash.getAnimTitleDuration()).playOn(mSubTxtTitle);
    }
