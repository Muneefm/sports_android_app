...
public class RFragment extends Fragment {
    ...
    int totalPages=1;
    String Url = Config.BASE_URL+Config.GROUP_MEMBER_R;
   ...
   // DilatingDotsProgressBar mDilatingDotsProgressBar;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        c = getContext();
        mRecyclerView = (RecyclerView) v.findViewById(R.id.recyclerViewr);
     //   mDilatingDotsProgressBar = (DilatingDotsProgressBar) v.findViewById(R.id.progressr);
        progLogin = (CircularProgressBar) v.findViewById(R.id.progR);
